    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center text-slate-600 font-sans">
        <div className="glass-panel px-8 py-6 flex items-center gap-4 animate-fade-in-up">
          ...
          <div>
            <span className="font-black text-[#1e1b4b] text-base block">Chargement des alertes pastorales...</span>
            <span className="text-xs text-slate-500 font-medium">Analyse des fidèles en absence prolongée</span>
          </div>
        </div>
      </div>
    );
